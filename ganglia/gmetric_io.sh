## der: /var/lib/cvs/ops/ganglia/disk_gmetric.sh,v 1.5 2007/11/30 17:29:27 ben Exp $
...
do
  ...
  ./gmetric.py --protocol="multicast" --port="8649"  --name="${devname}_reads" --value="$rps" --type="float" --units="blocks/sec"
  ./gmetric.py --protocol="multicast" --port="8649" --name="${devname}_writes" --value="$wps" --type="float" --units="blocks/sec"
...
./gmetric.py --protocol="multicast" --port="8649" --name="disk_reads" --value="$read_sum" --type="float" --units="blocks/sec"
./gmetric.py --protocol="multicast" --port="8649" --name="disk_writes" --value="$write_sum" --type="float" --units="blocks/sec"
